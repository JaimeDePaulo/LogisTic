...
const menuItems = [
  ...
  { icon: ArrowDownCircle, label: 'Entradas', path: '/entries' },
  { icon: ArrowUpCircle, label: 'Saídas', path: '/exits' },
  { icon: Database, label: 'Estoque', path: '/stock' },
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-semibold text-slate-900 leading-none">Jaime Paulo</p>
